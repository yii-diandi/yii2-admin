 ...
 * @Last Modified time: 2022-01-12 22:38:50
 */
...
<div class="auth-item-form">
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <?= Html::activeHiddenInput($model, 'is_sys', array('value' => $module_name === 'sys' ? 1 : 0)) ?>
            <?= $form->field($model, 'permission_level')->dropDownList([
                '0' => '默认',
                '1' => '页面',
                '2' => '按钮',
                '3' => '接口'
